...
int main()
{
	...
	cout << "(1)Проверка, (2)Обучение, (3)Сброс или (4)Выход (1 or 2 or 3 or 4)?" << endl;
	while (1)
	{
		cout << ">";
		cin >> dec;
		...
		if (dec == "3")
		{
			...
			while (1)
			{
				...
				if (drop == "Yes")
				{
					...
					Fcl.close();
					cout << endl << "(1)Проверка, (2)Обучение, (3)Сброс или (4)Выход (1 or 2 or 3 or 4)?" << endl;
					break;
				}
				if (drop == "No")
				{
		...
		if (dec == "1")
		{
			...
			float OutError = pow((O1ideal - O1output), 2);
			//////
			cout << endl << "Ответ равен " << O1output << endl << endl << "Возможная ошибка " << OutError*100 << "%" << endl << endl;
			cout << "(1)Проверка, (2)Обучение, (3)Сброс или (4)Выход (1 or 2 or 3 or 4)?" << endl;
		}
		if (dec == "2")
		{
			cout << endl << "Введите количество эпох (по умолчанию 15000)\n";
			cout << "maxEpoch = ";
			cin >> maxEpoch;
			cout << endl;
